...
public class TextUI implements Observer {
    ...
    public void update(Observable obs, Object ignore) {
         ...
         */
        System.out.printf(
                "Reading is %6.2f degrees C and %6.2f degrees K and %6.2f F and %6.2f Bar and %6.2f Mil%n",
                station.getCelsius(), station.getKelvin(), station.getFahrenheit(), station.getBar(), station.getBarM()) ;
    }
